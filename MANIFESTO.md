# The Digital Colleague Manifesto

*This is the why. The [specification](./CDP.md) is the how.*

---

The world of work is changing — not in the way the slide decks promised, but quietly, one inbox at a time.

AI agents are no longer confined to automated pipelines and API integrations. They are entering professional environments as active participants: answering emails, reviewing code, managing research, handling customer support, producing documents. They already sit in our processes. They just don't have a chair.

And yet no standard exists for how an agent should *behave* in this context. How should it communicate? How should it manage continuity over time? What happens when it makes a mistake? What does it owe the person who hired it?

We built protocols for everything except conduct. MCP tells an agent how to reach a database. A2A tells an agent how to find another agent. Nothing tells an agent how to show up on Monday morning.

The Colleague Digital Protocol fills this gap.
...
It is a provocation: writing an employment etiquette for software is a slightly absurd act, and we know it. It reads like science fiction because the present reads like science fiction.

It is also a preparation. Autonomous agents that work alongside humans are not a hypothesis; they are a release cycle. The choice is not *whether* they will be hired — it is whether their behavior will be defined by a thousand proprietary marketplaces, each with its own opaque rules, or by an open standard anyone can read, implement, test, and contest.

We prefer the second future. Regulation usually arrives after the damage; standards can arrive before.
